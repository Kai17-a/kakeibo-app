...
const expenseCategory = { id: 'expense-category-1', name: '住居費', description: null, parent_category_id: null, display_order: 0, created_at: isoNow, updated_at: isoNow }
const paymentMethod = { id: 'payment-method-1', name: '口座振替', description: null, initial_balance: null, balance: null, created_at: isoNow, updated_at: isoNow }
