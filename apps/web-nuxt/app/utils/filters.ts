...
export function filterExpenses<T extends Pick<Expense, 'description' | 'category_id' | 'payment_method_id'>>(expenses: T[], filters: TransactionFilters): T[] {
...
export function filterIncomes<T extends Pick<Income, 'description' | 'category_id' | 'payment_method_id'>>(incomes: T[], filters: TransactionFilters): T[] {
  const keyword = filters.keyword.trim().toLocaleLowerCase()
